...
Selectron.defaultProps = (_Selectron$defaultPro = {
  clearable: true,
  multi: false,
  placeholder: 'Please select...',
  required: false,
  searchable: true
}, _defineProperty(_Selectron$defaultPro, 'required', false), _defineProperty(_Selectron$defaultPro, 'onChange', function onChange() {}), _defineProperty(_Selectron$defaultPro, 'options', []), _defineProperty(_Selectron$defaultPro, 'value', null), _defineProperty(_Selectron$defaultPro, 'name', 'react-selectron-value'), _Selectron$defaultPro);
