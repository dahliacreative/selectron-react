...
Selectron.defaultProps = (_Selectron$defaultPro = {
  ...
  required: false,
  searchable: true
}, _defineProperty(_Selectron$defaultPro, 'required', false), _defineProperty(_Selectron$defaultPro, 'onChange', function onChange() {}), _defineProperty(_Selectron$defaultPro, 'options', []), _defineProperty(_Selectron$defaultPro, 'value', null), _defineProperty(_Selectron$defaultPro, 'name', 'selectron-react-value'), _Selectron$defaultPro);
