...
var Select = function (_React$Component) {
  ...
  function Select(props) {
    ...
    var methods = ['clickOutside', 'toggleOptions', 'onKeyDown', 'onKeyUp', 'onFocus', 'onBlur', 'onSearch', 'multiOnChange', 'updateScrollPosition', 'resize', 'toggleOverflow'].forEach(function (fn) {
  ...
  _createClass(Select, [{
    ...
    value: function multiOnChange(value) {
      ...
      if (remove) {
        ...
        if (options.length > 1) {
          ...
          var newHighlight = index + 1 > options.length - 1 ? options[index - 1] : options[index + 1];
    ...
    value: function render() {
      ...
      var _state3 = this.state,
          ...
          overflowing = _state3.overflowing;
      ...
      return _react2.default.createElement(
        ...
        isOpen && _react2.default.createElement(
          ...
          { select: this.select, ref: function ref(node) {
              _this3.options = node;
            }, onMount: this.updateScrollPosition, updateScroll: this.state.updateScroll, isOverflowing: overflowing, toggleOverflow: this.toggleOverflow },
        ...
        multi ? _react2.default.createElement('input', { type: 'hidden', name: name, value: value ? value.map(function (val) {
            return val.value;
          }).join(',') : '' }) : _react2.default.createElement('input', { type: 'hidden', name: name, value: value ? value.value : '' })
      );
    }
  }]);
