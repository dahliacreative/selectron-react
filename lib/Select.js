...
var Select = function (_React$Component) {
  ...
  function Select(props) {
    ...
    var methods = ['clickOutside', 'toggleOptions', 'onKeyDown', 'onKeyUp', 'onSearch', 'multiOnChange'].forEach(function (fn) {
  ...
  _createClass(Select, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'selectron', ref: function ref(node) {
            _this2.select = node;
          } },
        _react2.default.createElement(Trigger, triggerProps),
        value && clearable && _react2.default.createElement(
          'button',
          { type: 'button', className: 'selectron__clear', onClick: function onClick() {
              onChange(null);
            } },
          'Clear'
        ),
        isOpen && _react2.default.createElement(
          ...
          searchable && _react2.default.createElement(_Search2.default, searchProps),
          _react2.default.createElement(
            'ul',
            { className: 'selectron__list' },
            options.length > 1 && _react2.default.createElement(
              'li',
              { className: 'seectron__no-results' },
              'No results'
            ),
            options.map(function (option) {
              var isSelected = value ? option.value === value.value : false;
              var isHighlighted = option.value === highlighted.value;
              return _react2.default.createElement(_option2.default, { key: option.value, option: option, onChange: onChange, highlighted: isHighlighted, selected: isSelected, onMouseEnter: function onMouseEnter() {
                  _this2.setState({ highlighted: option });
                } });
            })
          )
        )
