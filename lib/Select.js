...
var Select = function (_React$Component) {
  ...
  function Select(props) {
    ...
    var methods = ['clickOutside', 'toggleOptions', 'onKeyDown', 'onKeyUp', 'onFocus', 'onBlur', 'onSearch', 'multiOnChange', 'updateScrollPosition', 'resize'].forEach(function (fn) {
      ...
      return _react2.default.createElement(
        ...
        isOpen && _react2.default.createElement(
          ...
          { select: this.select, ref: function ref(node) {
              _this3.options = node;
            }, onMount: this.updateScrollPosition, updateScroll: this.state.updateScroll },
